        ...
        <nav className="hidden md:flex items-center space-x-6">
          {session ? (
            <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
              ...
              <DropdownMenuContent 
                align="end" 
                className="w-64 p-2 bg-light-primary dark:bg-dark-primary border border-black-300/10 dark:border-white-500/10 rounded-xl shadow-lg"
              >
                <div className="px-3 py-2 mb-2 border-b border-black-300/10 dark:border-white-500/10">
                ...
                <Link href="/dashboard" onClick={() => setDropdownOpen(false)}>
                  <DropdownMenuItem className="rounded-lg text-black-300 dark:text-white-700 hover:bg-black-100/10 dark:hover:bg-white-500/10">
                    Dashboard
                  </DropdownMenuItem>
                </Link>
                ...
                <div className="mt-2 pt-2 border-t border-black-300/10 dark:border-white-500/10">
                  <DropdownMenuItem 
                    onClick={() => {
                      setDropdownOpen(false);
                      signOut({ callbackUrl: '/' });
                    }} 
                    className="rounded-lg text-black-300 dark:text-white-700 hover:bg-black-100/10 dark:hover:bg-white-500/10"
                  >
